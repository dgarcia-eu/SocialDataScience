...
Once you have the token created, it will be saved and you can loaded automatically in future R sessions. Other tutorials and exercises in this course will use this functionality, for example the [Twitter networks tutorial](), but if you run the code in an interactive R session, you can still run the tutorial even if you didn't get a developer account yet.
