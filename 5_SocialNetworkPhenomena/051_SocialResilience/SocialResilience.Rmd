...
Similar stories happened to MySpace, which went from being valued more than 12 Billion USD in 2008 to be bought by [Justin Timberlake for 35 Million USD](https://www.theguardian.com/technology/2011/jun/30/myspace-internet). Social networking platforms promoted by Google had similar fates, such as Orkut or Google+. Facebook, with more than 2 Billion users in 2020, has remained stable in terms of user base on the contrary, bringing the question of how to understand online social resilience.
