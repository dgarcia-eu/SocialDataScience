...
- The assortativity of the network could also be due to the degree distribution of the network. Try a permutation test but instead of permuting the labels of the nodes, generate a random network with the same degree sequence and keep the party labels with the corresponding nodes of their original degree. Do these simulations show high assortativity?
