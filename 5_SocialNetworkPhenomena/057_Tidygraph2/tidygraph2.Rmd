...
You can see the communities by drawing the nework with nodes colored by community. We casted the comunity values to characters so they get very distinct colors in the plot:
