...
Permutations here are just an example of what is called a **null model**. You can do the same as you did here for any null model to understand the plausibility of your empirical measurement in a random model that keeps some properties as your original data. This is especially useful in network analysis, where you can simulate null models like the ones in the [network models topic](https://dgarcia-eu.github.io/SocialDataScience/5_SocialNetworkPhenomena/055_NetworkModels/NetworkModels), measure something on each simulation, and compare the values with what you measured in your network data.
