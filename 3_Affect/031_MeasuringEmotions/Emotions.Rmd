...
Quoting Smith & Schneider, 2009:"researchers no longer take Plutchik's (1962, 1980, 2002) theory seriously.". Nevertheless, this model has been used as the basis for several text analysis methods you can find in the [unsupervised sentiment analysis topic](). More recent empirical research on self-reports finds a more comprehensive list of [27 emotional states](https://www.pnas.org/content/early/2017/08/30/1702247114) that can be used to list more complex emotions.
