...
VAD-ACL2018.pdf will require a suitable pdf reader such as Acrobat or Preview.


TERMS OF USE
------------
- The lexicons mentioned in this page can be used freely for research purposes.
- If you use a lexicon, then cite the associated papers.
- If interested in commercial use of any of these lexicons, send email to the contact. 
  Use of the lexicons in commercial applications without express consent from NRC is strictly prohibited.
- If you use a lexicon in a product or application, then please credit the authors and NRC appropriately. 
- Do not redistribute the data. Direct interested parties to the lexicon's webpage.
- National Research Council Canada (NRC) disclaims any responsibility for the use of the lexicons listed here 
  and does not provide technical support. 
