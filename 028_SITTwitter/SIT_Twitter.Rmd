...
# Appendix: Authenticating Twitter API requests

If you want to download more data or access other kind of data from Twitter, you might need a developer account on Twitter. You can apply for one following the steps in the vignette below. The process requires an employee of Twitter to check your application, so it might take a few days before you get it:
